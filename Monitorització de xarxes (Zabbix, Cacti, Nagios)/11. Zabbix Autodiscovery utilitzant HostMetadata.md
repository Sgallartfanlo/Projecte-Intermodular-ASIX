Sí, tens raó. La imatge del **pas 4 de la Fase 1** estava canviada. Aquí tens el **README sencer corregit**, amb les imatges col·locades on realment toquen.
...
* L’autoregistració automàtica de hosts Linux
* El descobriment de dispositius dins de la xarxa
* L’assignació automàtica de grups i plantilles
* La monitorització sense necessitat de crear els hosts manualment

---

Si vols, ara et puc deixar aquest mateix README amb un format una mica més professional per entregar a classe.
