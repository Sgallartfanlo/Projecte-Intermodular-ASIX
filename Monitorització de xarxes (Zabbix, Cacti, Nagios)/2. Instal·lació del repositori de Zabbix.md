...
## Pas 4 Instal·lació de PHP8.3 i extensions
Instal·lem PHP 8.3 i extensions
#### PHP 8.3
```bash
...
sudo -s
```
![Superusuari](img/zabbix_ins/Superusuari.png)
...
```
![Instal·lació del Repositori](img/zabbix_ins/REP_zabbix1.png)

Després s’instal·la el paquet descarregat:
```bash
dpkg -i zabbix-release_latest_7.4+ubuntu24.04_all.deb
```
![Instal·lació del Repositori](img/zabbix_ins/REP_zabbix2.png)

Finalment s’actualitza la llista de paquets del sistema:
```bash
apt update
```
![Actualitzar paquets](img/zabbix_ins/actualitzar_paquets.png)
...
```
![Instal·lació del Repositori](img/zabbix_ins/Install_Zabbixserverfrontendagent.png)
...
```
![Creacio BBDD](img/zabbix_ins/Schema_data.png)
...
![Edició del fitxer](img/zabbix_ins/Edicio_fitxer.png)


I es modifica la línia següent:
``DBPassword=password``
![Parametre del fitxer](img/zabbix_ins/Contingut_fitxer.png)
...
```
![Reinici i mostra de l'estat](img/zabbix_ins/Reinici_zabbix.png)
