...
| --- | --- | --- | --- |
| **Enfocament** | Serveis i hosts 

 | Integral (xarxa, servidors, apps) 

 | Gràfiques de rendiment 

 |
| **Interfície Web** | Bàsica 
...
| **Configuració** | Mitjana/Alta 
 ...
 |
| **Agents propis** | No (plugins externs) 
