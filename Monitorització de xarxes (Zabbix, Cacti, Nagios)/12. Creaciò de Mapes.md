...
Aquest document té com a objectiu guiar l'usuari a través del procés pas a pas per dissenyar, configurar i desplegar mapes de xarxa en la plataforma de monitoratge Zabbix. Els mapes són eines visuals potents que permeten centralitzar l'estat d'infraestructures complexes en una sola vista jeràrquica.

A continuació es detalla cada fase del flux de treball, acompanyada d'una captura de pantalla de referència que il·lustra la interfície de Zabbix en aquell punt. Totes les imatges es troben allotjades a la ruta `img/MP/`.
...
Ruta de la imatge: `img/MP/MP1.png`

![Pas 1: Accés al menú de mapes](img/MP/MP1.png)

*Descripció visual:* La captura mostra el menú lateral esquerre de Zabbix expandit, amb el focus sobre Monitoring i la subopció Maps seleccionada. Al panell central s'observa el llistat per defecte de mapes existents.
...
Ruta de la imatge: `img/MP/MP2.png`

![Pas 2: Configuració de propietats](img/MP/MP2.png)

*Descripció visual:* S'observa el formulari de propietats del mapa (Map properties). Els camps clau a omplir són:
* **Name:** Nom descriptiu (ex: Xarxa Central-Planta 1).
* **Width/Height:** Dimensions en píxels de l'àrea de dibuix.
* **Background image:** Imatge de fons opcional (ex: un plànol o mapa físic).
...
Ruta de la imatge: `img/MP/MP3.png`

![Pas 3: Editor de mapes en acció](img/MP/MP3.png)

*Descripció visual:* L'imatge mostra el Constructor (Constructor) de mapes. L'editor permet arrossegar i deixar anar icones. S'observen diferents elements que representen dispositius de xarxa. La barra d'eines superior mostra les opcions per afegir elements de mapa (Add Map element), com ara hosts, grups de hosts o altres submapes.
...
Ruta de la imatge: `img/MP/MP4.png`

![Pas 4: Vista final amb enllaços i estats](img/MP/MP4.png)

*Descripció visual:* Aquesta captura mostra un mapa finalitzat amb tots els elements i enllaços configurats. Es poden observar:
...
## Estructura del Directori de Fitxers

Perquè el document mostri les imatges correctament, l'estructura de fitxers ha de ser la següent:

```text
.
├── README.md           (aquest fitxer)
└── img/
    └── MP/          (carpeta on s'han de guardar les imatges físiques)
        ├── MP1.png
        ├── MP2.png
        ├── MP3.png
        └── MP4.png
