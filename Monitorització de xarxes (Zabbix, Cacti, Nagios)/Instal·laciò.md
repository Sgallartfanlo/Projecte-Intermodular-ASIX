...
![Actualització](img/server/Actualitzaciò.png)
...
![Sistema](img/server/Loginputty.png)

*Iniciem sessiò amb les credencials de l'usuari*

![Sistema](img/server/Iniciputty.png)
...
```
![Sistema](img/server/Comandes.png)
